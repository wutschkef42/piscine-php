<?php
    class Matrix
    {
        ...
        {
            $this->identity(1);
            $this->matrix[3] = $this->_vtc->getCoordX();
            $this->matrix[7] = $this->_vtc->getCoordY();
            $this->matrix[11] = $this->_vtc->getCoordZ();
        }
        ...
        {
            $tmp = array();
            $tmp['x'] = ($vtx->getCoordX() * $this->matrix[0]) + ($vtx->getCoordY() * $this->matrix[1]) + ($vtx->getCoordZ() * $this->matrix[2]) + ($vtx->getCoordW() * $this->matrix[3]);
            $tmp['y'] = ($vtx->getCoordX() * $this->matrix[4]) + ($vtx->getCoordY() * $this->matrix[5]) + ($vtx->getCoordZ() * $this->matrix[6]) + ($vtx->getCoordW() * $this->matrix[7]);
            $tmp['z'] = ($vtx->getCoordX() * $this->matrix[8]) + ($vtx->getCoordY() * $this->matrix[9]) + ($vtx->getCoordZ() * $this->matrix[10]) + ($vtx->getCoordW() * $this->matrix[11]);
            $tmp['w'] = ($vtx->getCoordX() * $this->matrix[11]) + ($vtx->getCoordY() * $this->matrix[13]) + ($vtx->getCoordZ() * $this->matrix[14]) + ($vtx->getCoordW() * $this->matrix[15]);
